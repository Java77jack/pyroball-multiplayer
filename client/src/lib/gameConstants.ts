...
export const TEAMS: Record<string, TeamData> = {
  ...
  glaciers:  { id: 'glaciers',  name: 'Glaciers',   primary: '#E0F0FF', secondary: '#4FC3F7', glow: '#00B0FF', accent: '#B3E5FC', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_glaciers-XyXXcMm9VwRqgJDJMxQrUC.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_glaciers_a58b4f7d.png' },
  ...
  rebellion: { id: 'rebellion', name: 'Rebellion',  primary: '#4A0000', secondary: '#D32F2F', glow: '#FF1744', accent: '#B71C1C', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_rebellion-ZxbZYEcCNNJE47vfnxXZkF.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_rebellion_3a0d21be.png' },
  ...
  havoc:     { id: 'havoc',     name: 'Havoc',      primary: '#1a1a1a', secondary: '#FFD600', glow: '#FFEA00', accent: '#FFC107', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_havoc-Rz7ZiL7w2KttBnYbqGigfe.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_havoc_b97e02d0.png' },
  wrath:     { id: 'wrath',     name: 'Wrath',      primary: '#3E2723', secondary: '#8B0000', glow: '#D50000', accent: '#4E342E', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_wrath-FfLC5ar29o36joJMp3tJc5.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_wrath_4cc01f76.png' },
  ...
  hoppers:   { id: 'hoppers',   name: 'Hoppers',    primary: '#1B5E20', secondary: '#76FF03', glow: '#64DD17', accent: '#CCFF90', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_hoppers-bPRmcpEU4Bh9y8BT2C6fUn.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_hoppers_5d589a7a.png' },
  gauchos:   { id: 'gauchos',   name: 'Gauchos',    primary: '#4E342E', secondary: '#D4A574', glow: '#FFB74D', accent: '#8D6E63', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_gauchos-gDvvtLNJagecx9yhyDubp4.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_gauchos_83fa74a7.png' },
  engineers: { id: 'engineers', name: 'Engineers',  primary: '#BF360C', secondary: '#FF6D00', glow: '#FF9100', accent: '#E65100', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_engineers-EvcoveSLiA6AowVA7PpRjM.webp', spriteSheet: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/sprites_engineers_e7f80c7a.png' },
};
