...
export const TEAMS: Record<string, TeamData> = {
  inferno:   { id: 'inferno',   name: 'Inferno',    primary: '#1a1a1a', secondary: '#FF6B00', glow: '#FF4500', accent: '#FFB800', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663476839256/L959pTVNCfBxbsJyQ7g7yz/logo_inferno_transparent_5b2bf189.png', stats: { speed: 8, scoring: 9, rebounding: 7, aggressiveness: 9 } },
  vortex:    { id: 'vortex',    name: 'Vortex',     primary: '#0a2463', secondary: '#3E92CC', glow: '#00B4D8', accent: '#90E0EF', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663476839256/L959pTVNCfBxbsJyQ7g7yz/logo_vortex_transparent_68e2cef4.png', stats: { speed: 9, scoring: 7, rebounding: 6, aggressiveness: 7 } },
  empire:    { id: 'empire',    name: 'Empire',     primary: '#f0f0f0', secondary: '#FFB800', glow: '#FFD700', accent: '#1a1a1a', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663476839256/L959pTVNCfBxbsJyQ7g7yz/logo_empires_transparent_cc5483fd.png', stats: { speed: 6, scoring: 8, rebounding: 8, aggressiveness: 6 } },
  sledge:    { id: 'sledge',    name: 'Sledge',     primary: '#4a4a5a', secondary: '#C0C0C0', glow: '#FFB800', accent: '#2a2a3a', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663476839256/L959pTVNCfBxbsJyQ7g7yz/logo_sledge_transparent_772d4485.png', stats: { speed: 5, scoring: 6, rebounding: 9, aggressiveness: 8 } },
  glaciers:  { id: 'glaciers',  name: 'Glaciers',   primary: '#E0F0FF', secondary: '#4FC3F7', glow: '#00B0FF', accent: '#B3E5FC', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_glaciers-XyXXcMm9VwRqgJDJMxQrUC.webp', stats: { speed: 7, scoring: 6, rebounding: 7, aggressiveness: 5 } },
  blueclaws: { id: 'blueclaws', name: 'Blue Claws', primary: '#0D47A1', secondary: '#1565C0', glow: '#2196F3', accent: '#64B5F6', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_blueclaws-czW9AKMTtgJuUcFz8qvqge.webp', stats: { speed: 7, scoring: 7, rebounding: 8, aggressiveness: 6 } },
  nightraid: { id: 'nightraid', name: 'Night Raid', primary: '#1A0033', secondary: '#7B1FA2', glow: '#CE93D8', accent: '#4A148C', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_nightraid-Lk9qDVYXUjLrJgQrqVCRxH.webp', stats: { speed: 8, scoring: 8, rebounding: 6, aggressiveness: 8 } },
  seawolves: { id: 'seawolves', name: 'Seawolves',  primary: '#004D40', secondary: '#26A69A', glow: '#00BFA5', accent: '#80CBC4', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_seawolves-CebZBokd7UKwnzCGjToBnY.webp', stats: { speed: 6, scoring: 7, rebounding: 8, aggressiveness: 7 } },
  rebellion: { id: 'rebellion', name: 'Rebellion',  primary: '#4A0000', secondary: '#D32F2F', glow: '#FF1744', accent: '#B71C1C', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_rebellion-ZxbZYEcCNNJE47vfnxXZkF.webp', stats: { speed: 7, scoring: 8, rebounding: 7, aggressiveness: 9 } },
  railers:   { id: 'railers',   name: 'Railers',    primary: '#37474F', secondary: '#90A4AE', glow: '#CFD8DC', accent: '#263238', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_railers-NqnCShRaB8zUporfgzRddM.webp', stats: { speed: 6, scoring: 6, rebounding: 7, aggressiveness: 6 } },
  havoc:     { id: 'havoc',     name: 'Havoc',      primary: '#1a1a1a', secondary: '#FFD600', glow: '#FFEA00', accent: '#FFC107', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_havoc-Rz7ZiL7w2KttBnYbqGigfe.webp', stats: { speed: 8, scoring: 9, rebounding: 6, aggressiveness: 9 } },
  wrath:     { id: 'wrath',     name: 'Wrath',      primary: '#3E2723', secondary: '#8B0000', glow: '#D50000', accent: '#4E342E', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_wrath-FfLC5ar29o36joJMp3tJc5.webp', stats: { speed: 5, scoring: 7, rebounding: 9, aggressiveness: 9 } },
  sizzle:    { id: 'sizzle',    name: 'Sizzle',     primary: '#880E4F', secondary: '#E91E63', glow: '#FF4081', accent: '#F48FB1', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_sizzle-o9vAB9dyPMwdtNKkDYxchj.webp', stats: { speed: 9, scoring: 8, rebounding: 5, aggressiveness: 8 } },
  hoppers:   { id: 'hoppers',   name: 'Hoppers',    primary: '#1B5E20', secondary: '#76FF03', glow: '#64DD17', accent: '#CCFF90', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_hoppers-bPRmcpEU4Bh9y8BT2C6fUn.webp', stats: { speed: 9, scoring: 7, rebounding: 5, aggressiveness: 7 } },
  gauchos:   { id: 'gauchos',   name: 'Gauchos',    primary: '#4E342E', secondary: '#D4A574', glow: '#FFB74D', accent: '#8D6E63', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_gauchos-gDvvtLNJagecx9yhyDubp4.webp', stats: { speed: 6, scoring: 7, rebounding: 8, aggressiveness: 7 } },
  engineers: { id: 'engineers', name: 'Engineers',  primary: '#BF360C', secondary: '#FF6D00', glow: '#FF9100', accent: '#E65100', logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663489271487/bLh3StKHGXUj5K9umHEgwQ/logo_engineers-EvcoveSLiA6AowVA7PpRjM.webp', stats: { speed: 7, scoring: 8, rebounding: 8, aggressiveness: 8 } },
};
